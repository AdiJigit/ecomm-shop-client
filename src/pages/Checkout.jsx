...
const Checkout = ({ setOpen, cartItems, taxPrice, totalPrice, subTotal }) => {
  ...
  const orderProductHandler = async (e) => {
    ...
    try {
      ...
      toast.error(
        'Order failed. Please, try to fill option for colors and sizes'
      );
    }
  };
      ...
      <div className="hidden sm:block">
        <div className="co-container">
          <form onSubmit={orderProductHandler}>
            <h5 className="co-title text-xl font-bold uppercase">
            ...
            <div className="form-btn flex justify-center items-center">
              <button
                className="flex gap-[10px] bg-green-500 hover:scale-105 text-black uppercase font-bold py-2 px-8"
                type="submit"
              >
                Order <CiDeliveryTruck size={20} />
              </button>
            </div>
          </form>
        </div>
