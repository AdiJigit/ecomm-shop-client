            ...
            <div className="pd-col">
              <div className="pg-groups">
                ...
                <div className="pd-group">
                  ...
                  <span className="pd-subcategory font-bold">
                    {product.subcategory}
                  </span>
                </div>
                <div className="pd-group">
                ...
                <div className="pd-group">
                  <div className="pd-otherAction">
                    <div className="pd-size">
                      <h4 className="pd-sizeTitle font-bold text-[14px]">
                        SIZES:
                      </h4>
          ...
          <div>
            ...
            <div className="pd-col">
              <div className="pg-groups">
                ...
                <div className="pd-group">
                  <span className="pd-category text-xl">
                    {product.category}
                  </span>
                  <span className="pd- text-lg font-bold">
                    {product.subcategory}
                  </span>
                </div>
                <div className="pd-group">
                ...
                <div className="pd-group">
                  <p className="text-lg">
                    QUANTITY: <span className="text-xl font-bold">1</span>
                  </p>
                </div>
                <div className="pd-group">
                  <div className="pd-otherAction">
                    ...
                    <div className="pd-color">
                      <h4 className="pd-sizeTitle font-bold text-lg">
                        COLORS:
                      </h4>
                      <div className="pd-sizeDiv">
                        {product.colors?.map((color) => (
                ...
                <div className="pd-group">
                  <div className="pd-buttonsgroup">
                    <button
                      className="pd-wish text-lg"
                      onClick={addToWishHandler}
                    >
                      ADD TO WISH
                    </button>
                    <button
                      className="pd-cart text-lg"
