...
const ShopMainPart = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async() => {
      ...
      //fetch all Category
      const resultCategory = await axios('https://jigit-api.onrender.comapi/category/all');
      // console.log(resultCategory.data)
      setCategory(resultCategory.data)


      //fetch all Rating
      const resultRating = await axios('https://jigit-api.onrender.comapi/rating/all');
