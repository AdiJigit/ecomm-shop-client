...
const Slider = () => {
  ...
  return (
      <div className='snapClass snap-y snap-mandatory overflow-auto w-screen h-screen scroll-smooth'>
        {slideIndex === 1 ?
        <Arrow onClick={()=>handleClick('left')} direction='left' className='w-[100px] h-[50px] flex items-center justify-center fixed top-0 bottom-0 m-auto left-0 text-white cursor-pointer z-10'>
        ...
        <div className='flex h-screen w-sreen'>
            <Wrapper slideIndex={slideIndex} className='snap-start h-full flex transition-all ease-in-out duration-1000'>
              <SlidePage1 />
            </Wrapper>
          </div>
        ...
        {slideIndex === 0 ?
        <Arrow onClick={()=>handleClick('right')} direction='right' className='w-[100px] h-[50px] flex items-center justify-center fixed top-0 bottom-0 m-auto right-0 text-white cursor-pointer'>
          <div className='flex items-center justify-center'>
            <span>Women</span>
